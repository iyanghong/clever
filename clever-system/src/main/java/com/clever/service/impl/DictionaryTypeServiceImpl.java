...
public class DictionaryTypeServiceImpl implements DictionaryTypeService {
     ...
     */
    @Override
    public Page<DictionaryType> selectPage(Integer pageNumber, Integer pageSize,String platformId,String name,String code) {
    ...
    public List<DictionaryType> selectListByPlatformId(String platformId) {
        return dictionaryTypeMapper.selectList(new QueryWrapper<DictionaryType>().eq("platform_id", platformId).orderByAsc("primaryKeyColumn.columnName"));
    }
    /**
     * 根据创建者id获取列表
     *
    ...
    public List<DictionaryType> selectListByCreator(String creator) {
        return dictionaryTypeMapper.selectList(new QueryWrapper<DictionaryType>().eq("creator", creator).orderByAsc("primaryKeyColumn.columnName"));
    }
    /**
    * 新建字典类型
    *

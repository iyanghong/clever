...
public class AreaServiceImpl implements AreaService {
     ...
     */
    @Override
    public Area create(Area area, OnlineUser onlineUser) {
     ...
     */
    @Override
    public Area update(Area area, OnlineUser onlineUser) {
     ...
     */
    @Override
    public Area save(Area area, OnlineUser onlineUser) {
        if (area.getId() != null) {
            return create(area, onlineUser);
        }
        return update(area, onlineUser);
    }
    ...
    public void deleteByCityId(Integer cityId, OnlineUser onlineUser) {
        ...
        log.info("城区地址, 城区地址信息根据cityId删除成功: userId={}, cityId={}", onlineUser.getId(), cityId);
    }
    ...
    public void deleteByProvinceId(Integer provinceId, OnlineUser onlineUser) {
        ...
        log.info("城区地址, 城区地址信息根据provinceId删除成功: userId={}, provinceId={}", onlineUser.getId(), provinceId);
    }
}

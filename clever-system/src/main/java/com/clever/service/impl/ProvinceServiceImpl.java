...
public class ProvinceServiceImpl implements ProvinceService {
     ...
     */
    @Override
    public Province create(Province province, OnlineUser onlineUser) {
     ...
     */
    @Override
    public Province update(Province province, OnlineUser onlineUser) {
     ...
     */
    @Override
    public Province save(Province province, OnlineUser onlineUser) {
        if (province.getId() != null) {
            return create(province, onlineUser);
        }
        return update(province, onlineUser);
    }

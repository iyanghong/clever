...
public class ThirdAccountServiceImpl implements ThirdAccountService {
     ...
     */
    @Override
    public ThirdAccount create(ThirdAccount thirdAccount, OnlineUser onlineUser) {
     ...
     */
    @Override
    public ThirdAccount update(ThirdAccount thirdAccount, OnlineUser onlineUser) {
     ...
     */
    @Override
    public ThirdAccount save(ThirdAccount thirdAccount, OnlineUser onlineUser) {
        if (StringUtils.isNotBlank(thirdAccount.getId())) {
            return create(thirdAccount, onlineUser);
        }
        return update(thirdAccount, onlineUser);
    }
    ...
    public void deleteByOpenId(String openId, OnlineUser onlineUser) {
        ...
        log.info("第三方平台账号, 第三方平台账号信息根据openId删除成功: userId={}, openId={}", onlineUser.getId(), openId);
    }
    ...
    public void deleteByUserId(String userId, OnlineUser onlineUser) {
        ...
        log.info("第三方平台账号, 第三方平台账号信息根据userId删除成功: userId={}, userId={}", onlineUser.getId(), userId);
    }
}

...
public class EmailTemplateController {
    ...
    public Result<List<EmailTemplate>> selectListByCreator(@PathVariable("creator") String creator) {
        return new Result<>(emailTemplateService.selectListByCreator(creator), "查询成功");
    }

...
public class Main {
    public static void main(String[] args) {
        ...
        // 生成实体类
        handler.generate("", "/clever-common/src/main/java/com/clever/bean/system");
        // 创建一个GenerateMapperXML对象，用于生成mapper.xml文件
        GenerateMapperXML generateMapperXML = new GenerateMapperXML(generateDatabaseConfig);
        // 生成mapper.xml文件
        generateMapperXML.generate("", "/clever-system/src/main/resources/com/clever/mapper");
        ...
        // 生成mapper类
        generateMapper.generate("", "/clever-system/src/main/java/com/clever/mapper");
        ...
        // 生成service类
        generateService.generate("", "/clever-system/src/main/java/com/clever/service");


        // 创建一个GenerateController对象，用于生成controller类
        GenerateController controller = new GenerateController(generateDatabaseConfig);
        // 生成controller类
        controller.generate("", "/clever-system/src/main/java/com/clever/controller");


        GenerateApiPost generateApiPost = new GenerateApiPost(generateDatabaseConfig);
        generateApiPost.generate("/clever-system/src/main/resources");
    }
}